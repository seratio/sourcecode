...
import shouldBehaveLikeBurnableToken from "./ERC20/BurnableToken.behaviour";

const StudentTokenMock = artifacts.require("StudentTokenMock");
...
contract("StudentToken", function([owner, burner]) {
  const initialBalance = 1000;

  beforeEach(async function() {
    this.token = await StudentTokenMock.new(owner, initialBalance);
  });
