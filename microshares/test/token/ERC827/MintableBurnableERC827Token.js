...
var MintableBurnableERC827TokenMock = artifacts.require('MintableBurnableERC827TokenMock');
...
contract('Mintable Burnable ERC827 Token - ERC 827 functionality', function (accounts) {
  let token;
  ...
  beforeEach(async function () {
    token = await MintableBurnableERC827TokenMock.new(accounts[0], 100);
  });
  ...
  it('should return the correct allowance amount after approval', async function () {
    let token = await MintableBurnableERC827TokenMock.new(accounts[0], 100);
