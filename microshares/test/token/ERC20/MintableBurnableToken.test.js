...
const MintableBurnableTokenMock = artifacts.require('MintableBurnableTokenMock');

contract('MintableBurnableToken', function ([owner, anotherAccount]) {
  const initialBalance = 1000;
  beforeEach(async function () {
    this.token = await MintableBurnableTokenMock.new(owner, initialBalance, {from: owner});
  });
