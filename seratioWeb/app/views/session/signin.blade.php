	...
	<div class="login-container">
		...
		<div class="login-form">
			...
			<div class="login-content">
				...
				<div class="form-group">
					<a href= "{{URL::route('frontend.pv')}}" class="btn btn-lg btn-warning btn-block" title="For Personal Value signup, please click here">For Personal Value signup, please click here</a>
				</div>
