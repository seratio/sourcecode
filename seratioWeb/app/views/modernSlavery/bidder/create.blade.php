...
Seratio::Bidder::Modern Slavery::Add a Record
@endif
@parent
@stop
@section('content')
                     ...
                     <div class="row">
                        <div class="col-lg-10">
                           <div class="col-md-8">
                              ...
                              <p class="help-block">{{ $errors->first('financial_year') }}</p>
                              @endif
                              <br>
                              <div class="input-group">
                              ...
                              <p class="help-block">{{ $errors->first('total_salary') }}</p>
                              @endif
                              <br>
                              <div class="input-group">
                                 <div class="input-group-addon">#</div>
                              ...
                              <p class="help-block">{{ $errors->first('total_staff') }}</p>
                              @endif
                              <br>
                              <div class="input-group">
