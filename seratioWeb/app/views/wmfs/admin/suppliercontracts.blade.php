          ...
          <div class="box-body table-responsive" style="overflow: scroll;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $value->supplier_id ? Wmsupplier::find($value->supplier_id)->supplier_name : 'N/A' }}</td>
                ...
                <td>
                  <a data-method="delete" data-confirm="Are you sure?" class="btn btn-danger btn-xs" href="{{ route('tenders.destroy', ['id' => $value->id]) }}" title="Delete Tender">
  ...
  <div class="modal-dialog custom-modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {{ Form::open(array('route' => array('contract.assign'), 'method' => 'POST')) }}
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="form-group">
              ...
              @if ($errors->has('contract_id'))  <p class="help-block" style="color:red">{{ $errors->first('contract_id') }}</p> @endif
            </div>


            <div class="form-group">
              <label>Supplier Name</label>
              {{ Form::select('supplier_id', Wmsupplier::forSelect(), '',  array('class' => 'form-control', 'required')) }}
              @if ($errors->has('supplier_id'))  <p class="help-block" style="color:red">{{ $errors->first('supplier_id') }}</p> @endif
            </div>

            <div class="form-group">
              <label>Financial Year</label>
              {{ Form::select('financial_year', [], '',  array('id' => 'financial_year', 'class' => 'form-control', 'required')) }}
              @if ($errors->has('financial_year'))  <p class="help-block" style="color:red">{{ $errors->first('financial_year') }}</p> @endif
            </div>
