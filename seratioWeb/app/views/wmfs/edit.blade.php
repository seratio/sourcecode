        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="container">
              ...
              {{ Form::open(array('route' => array('organisation.update', $wmfs->id), 'method' => 'PUT')) }}
                ...
                <div class="col-lg-10">
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                      ...
                      {{ Form::text('measured_year', $wmfs->measured_year, array('class' => 'form-control', 'placeholder' => 'Measured Year', 'required', 'disabled')) }}
                    ...
                    <div class="input-group">
                      <div class="input-group-addon"></div>
                      {{ Form::text('targeted_audience', $wmfs->targeted_audience, array('class' => 'form-control', 'placeholder' => 'Who is your target audience?', 'required')) }}
                    ...
                    <div class="input-group">
                      <div class="input-group-addon">#</div>
                      {{ Form::text('positive', $wmfs->positive, array('class' => 'form-control', 'placeholder' => 'Positive', 'required')) }}
                    ...
                    <div class="input-group">
                      ...
                      {{ Form::text('neutral', $wmfs->neutral, array('class' => 'form-control', 'placeholder' => 'Neutral', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">#</span>
                      {{ Form::text('negative', $wmfs->negative, array('class' => 'form-control', 'placeholder' => 'Negative', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">#</span>
                      {{ Form::text('target_population', $wmfs->target_population, array('class' => 'form-control', 'placeholder' => 'Target Population', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">%</span>
                      {{ Form::text('margin_errors', $wmfs->margin_errors, array('class' => 'form-control', 'type'=>'number', 'min' => '0', 'max'=> '100', 'placeholder' => 'Margin of errors', 'required')) }}
                    ...
                    <div class="input-group">
                      ...
                      {{ Form::text('sentiment_date', $wmfs->sentiment_date, array('class' => 'form-control datepicker', 'placeholder' => 'Sentiment Date', 'required')) }}
                ...
                <div class="col-xs-10">
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                      ...
                      {{ Form::text('non_statutory_spend', $wmfs->non_statutory_spend, array('class' => 'form-control', 'placeholder' => 'Non-Statutory Spend', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">#</span>
                      {{ Form::text('no_of_service_users', $wmfs->no_of_service_users, array('class' => 'form-control', 'placeholder' => 'Number of Service Users', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('net_asset_value', $wmfs->net_asset_value, array('class' => 'form-control', 'placeholder' => 'Net Asset Value', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">#</span>
                      {{ Form::text('staff', $wmfs->staff, array('class' => 'form-control', 'placeholder' => 'Number of staff', 'required')) }}
                    ...
                    <div class="input-group">
                      ...
                      {{ Form::text('carbon_reduction_t', $wmfs->carbon_reduction_t, array('class' => 'form-control', 'placeholder' => 'Carbon Reduction ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">tCO2e</span>
                      {{ Form::text('carbon_offset', $wmfs->carbon_offset, array('class' => 'form-control', 'placeholder' => 'Carbon Offset ', 'required')) }}
              ...
              <div class="row setup-content" id="step-3">
                <div class="col-xs-10">
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">#m</span>
                      {{ Form::text('people', $wmfs->people, array('class' => 'form-control', 'placeholder' => 'People', 'required')) }}
              ...
              <div class="row setup-content" id="step-4">
                <div class="col-xs-10">
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('money_leveraged', $wmfs->money_leveraged, array('class' => 'form-control', 'placeholder' => 'Money Leveraged', 'required')) }}
              ...
              <div class="row setup-content" id="step-5">
                <div class="col-xs-10">
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_directors_salary', $wmfs->cu_directors_salary, array('class' => 'form-control', 'placeholder' => 'Directors Salary', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_members_salary', $wmfs->cu_members_salary, array('class' => 'form-control', 'placeholder' => 'Members Salary  ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_staff_salary_bill', $wmfs->cu_staff_salary_bill, array('class' => 'form-control', 'placeholder' => 'Total Staff Salary Bill ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_executive_board', $wmfs->cu_executive_board, array('class' => 'form-control', 'placeholder' => 'Executive Board (Total number)', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_total_counc_members', $wmfs->cu_total_counc_members, array('class' => 'form-control', 'placeholder' => 'Total number of councillors/members ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_total_board_senior_directors', $wmfs->cu_total_board_senior_directors, array('class' => 'form-control', 'placeholder' => 'Total number of Board/Senior Executives/Directors ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('cu_total_staff', $wmfs->cu_total_staff, array('class' => 'form-control', 'placeholder' => 'Total number of staff  ', 'required')) }}
              ...
              <div class="row setup-content" id="step-6">
                <div class="col-xs-10">
                  <div class="col-md-8">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_directors_salary', $wmfs->py_directors_salary, array('class' => 'form-control', 'placeholder' => 'Directors Salary', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_members_salary', $wmfs->py_members_salary, array('class' => 'form-control', 'placeholder' => 'Members Salary  ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_staff_salary_bill', $wmfs->py_staff_salary_bill, array('class' => 'form-control', 'placeholder' => 'Total Staff Salary Bill ', 'required')) }}
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_executive_board', $wmfs->py_executive_board, array('class' => 'form-control', 'placeholder' => 'Executive Board (Total number)', 'required')) }}
                      <label class="input-group-addon" data-toggle="tooltip" data-placement="left" title="Total number of individuals on board (senior board/senior executives/directors and Councillors /Members)."><a href="#">Executive Board (Total number)</a></label>
                    </div>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_total_counc_members', $wmfs->py_total_counc_members, array('class' => 'form-control', 'placeholder' => 'Total number of councillors/members ', 'required')) }}
                      <label class="input-group-addon" data-toggle="tooltip" data-placement="left" title="Total number of individual councillors and members."><a href="#">Total number of councillors/members</a></label>
                    </div>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_total_board_senior_directors', $wmfs->py_total_board_senior_directors, array('class' => 'form-control', 'placeholder' => 'Total number of Board/Senior Executives/Directors ', 'required')) }}
                      <label class="input-group-addon">Total number of Board/Senior Executives/Directors </label>
                    </div>
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">£m</span>
                      {{ Form::text('py_total_staff', $wmfs->py_total_staff, array('class' => 'form-control', 'placeholder' => 'Total number of staff  ', 'required')) }}
                      <label class="input-group-addon">Total number of staff</label>
                    </div>
                    ...
                    {{ Form::hidden('user_id', $wmfs->user_id, array('class' => 'form-control', 'placeholder' => 'User ID', 'required')) }}
                    <div class="input-group">
                      <label>Organisation</label>
                      <select class ="form-control"
                      {{ Form::select('user_id', User::forselect(),$wmfs->user_id, array('required', 'disabled', 'id' => 'user_id')) }}
