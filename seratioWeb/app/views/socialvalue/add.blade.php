   ...
   <section class="content">
      <div class="row">
         ...
         <div class="container">
            ...
            {{ Form::open(array('route'=> 'socialvalue.store', 'class' => 'form')) }}
               ...
               <div class="col-xs-10">
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        ...
                        {{ Form::number('positive', '', array('class' => 'form-control', 'placeholder' => 'Positive', 'required')) }}
                     ...
                     <div class="input-group">
                        ...
                        {{ Form::number('neutral', '', array('class' => 'form-control', 'placeholder' => 'Neutral', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('negative', '', array('class' => 'form-control', 'placeholder' => 'Negative', 'required')) }}
               ...
               <div class="col-xs-10">
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        ...
                        {{ Form::number('csr', '', array('class' => 'form-control', 'placeholder' => 'CSR', 'required')) }}
                        @if ($errors->has('csr'))
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('deg_of_separation', '', array('class' => 'form-control', 'placeholder' => 'Deg of Separation', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#m</span>
                        {{ Form::number('shares', '', array('class' => 'form-control', 'placeholder' => 'Shares', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('capititilization_NAV', '', array('class' => 'form-control', 'placeholder' => 'Capitalisation/NAV', 'required')) }}
                        @if ($errors->has('capititilization_NAV'))
                        <p class="help-block">{{ $errors->first('capititilization_NAV') }}</p>
                        @endif
                        <label class="input-group-addon">Capitalisation/NAV</label>
                     </div>
                     <br>
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('staff', '', array('class' => 'form-control', 'placeholder' => 'Staff', 'required')) }}
                        @if ($errors->has('staff'))
                     ...
                     <div class="input-group">
                        ...
                        {{ Form::number('carbon_reduction_t', '', array('class' => 'form-control', 'placeholder' => 'Carbon Reduction t ', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">tCO2e</span>
                        {{ Form::number('carbon_offset', '', array('class' => 'form-control', 'placeholder' => 'Carbon Offset ', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£</span>
                        {{ Form::number('value_tCO2e_non_traded', '', array('class' => 'form-control', 'placeholder' => 'Value tCO2 Non Traded', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£</span>
                        {{ Form::number('value_tCO2e_traded', '', array('class' => 'form-control', 'placeholder' => 'Value tCO2 Traded', 'required')) }}
            ...
            <div class="row setup-content" id="step-3">
               <div class="col-xs-10">
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#m</span>
                        {{ Form::number('people', '', array('class' => 'form-control', 'placeholder' => 'People', 'required')) }}
            ...
            <div class="row setup-content" id="step-4">
               <div class="col-xs-10">
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('money_leveraged', '', array('class' => 'form-control', 'placeholder' => 'Money Leveraged', 'required')) }}
            ...
            <div class="row setup-content" id="step-5">
               <div class="col-xs-10">
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_directors_salary_executive', '', array('class' => 'form-control', 'placeholder' => 'Directory Salary(Executive)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_directors_salary_non_executive', '', array('class' => 'form-control', 'placeholder' => 'Directory Salary(Non-Executive)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_staff_salary', '', array('class' => 'form-control', 'placeholder' => 'Staff Salary', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_staff_salary_without_directors', '', array('class' => 'form-control', 'placeholder' => 'Staff Salary (without directors)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_tax_charged', '', array('class' => 'form-control', 'placeholder' => 'Tax Charge', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_total_share_holder_pay_dividend_cash', '', array('class' => 'form-control', 'placeholder' => 'Total Shareholder Pay (Divident)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('current_year_executive_board', '', array('class' => 'form-control', 'placeholder' => 'Executive Board', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('current_year_non_executive_board', '', array('class' => 'form-control', 'placeholder' => 'Non-Executive Board', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_board_total', '', array('class' => 'form-control', 'placeholder' => 'Board Total', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('current_year_number_of_staffs', '', array('class' => 'form-control', 'placeholder' => 'Number of Staff', 'required')) }}
            ...
            <div class="row setup-content" id="step-6">
               <div class="col-xs-10">
                  <div class="col-md-8">
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('prior_year_directors_salary_executive', '', array('class' => 'form-control', 'placeholder' => 'Directory Salary(Executive)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('prior_year_directors_salary_non_executive', '', array('class' => 'form-control', 'placeholder' => 'Directory Salary(Non-Executive)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('prior_year_staff_salary', '', array('class' => 'form-control', 'placeholder' => 'Staff Salary', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('prior_year_staff_salary_without_directors', '', array('class' => 'form-control', 'placeholder' => 'Staff Salary (without directors)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('prior_year_tax_charged', '', array('class' => 'form-control', 'placeholder' => 'Tax Charge', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">£m</span>
                        {{ Form::number('prior_year_total_share_holder_pay_dividend_cash', '', array('class' => 'form-control', 'placeholder' => 'Total Shareholder Pay (Divident)', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('prior_year_executive_board', '', array('class' => 'form-control', 'placeholder' => 'Executive Board', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('prior_year_non_executive_board', '', array('class' => 'form-control', 'placeholder' => 'Non-Executive Board', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('prior_year_board_total', '', array('class' => 'form-control', 'placeholder' => 'Board Total', 'required')) }}
                     ...
                     <div class="input-group">
                        <span class="input-group-addon">#</span>
                        {{ Form::number('prior_year_number_of_staffs', '', array('class' => 'form-control', 'placeholder' => 'Number of Staff', 'required')) }}
               ...
               <div class="col-xs-10">
                  <div class="col-md-12">
                     ...
                     <div class="input-group">
                        ...
                        {{ Form::select('user_id', User::forselect(), array('required')) }}
                        @if ($errors->has('title'))
