...
*/
body{
	background: url(../assets_frontend/images/error/bg1.png);
...
<body>
		...
		<div class="wrap">
			...
			<!--start-content------>
			<div class="content">
				<img src="assets_frontend/images/error/error-img.png" title="error" />
				<p><span><label>O</label>hh.....</span>You Requested the page that is no longer There.</p>
				<a href="{{URL::route('home.index')}}">Back To Home</a>
