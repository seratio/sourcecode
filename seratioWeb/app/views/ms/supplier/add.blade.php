...
@section('title')
SE Ratio::Modern Slavery::Add a Supplier
@parent
@stop
@section('content')
               ...
               <div class="box-body">
                  ...
                  <div class="row">
                     <div class="col-lg-6">
                        <div class="form-group">
                           <label>Address</label>
                           {{ Form::text('number_street', '', array('class' => 'form-control', 'placeholder' => 'Address', 'required')) }}
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="form-group">
                           <label>Sector</label>
                           <select class ="form-control"
                           {{ Form::select('sector', $sectors, array('class' => 'form-control', 'required')) }}
                        ...
                        <div class="form-group">
                           ...
                           <select class ="form-control"
                           {{ Form::select('main_industry', $industries, array('class' => 'form-control', 'required')) }}
